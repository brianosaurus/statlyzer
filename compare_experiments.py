...
EXPERIMENTS = {
    ...
    "AA": {"db": "exp_aa.db", "label": "0bps $5k",
            "desc": "40pos/10tok/5x/5%/z2.0-4.0/ez0.3/0bps/30s/LL/$5k"},
    "BB": {"db": "exp_bb.db", "label": "5bps $5k",
            "desc": "40pos/10tok/5x/5%/z2.0-4.0/ez0.3/5bps/30s/LL/$5k"},
    "CC": {"db": "exp_cc.db", "label": "15bps $5k",
            "desc": "40pos/10tok/5x/5%/z2.0-4.0/ez0.3/15bps/30s/LL/$5k"},
    "DD": {"db": "exp_dd.db", "label": "25bps $5k",
            "desc": "40pos/10tok/5x/5%/z2.0-4.0/ez0.3/25bps/30s/LL/$5k"},
    # Phase 2: Optimized for profit
    "EE": {"db": "exp_ee.db", "label": "MaxVol $20k",
            "desc": "60pos/15tok/5x/10%/z1.5-4.0/ez0.1/10bps/30s/100hr/LL/$20k"},
    "FF": {"db": "exp_ff.db", "label": "HiZ $10k",
            "desc": "40pos/10tok/5x/7%/z2.5-4.0/ez0.2/10bps/30s/noStop/LL/$10k"},
    "GG": {"db": "exp_gg.db", "label": "Fast $10k",
            "desc": "40pos/10tok/5x/10%/z2.0-4.0/ez0.2/15bps/15s/60hr/LL/$10k"},
    "HH": {"db": "exp_hh.db", "label": "P-opt $10k",
            "desc": "40pos/10tok/4x/7%/z2.7-3.5/ez0.3/10bps/30s/40hr/LL/$10k"},
    # Phase 3: Whitelist (real slippage, low-slippage tokens only)
    "II": {"db": "exp_ii.db", "label": "WL $10k",
            "desc": "40pos/10tok/5x/7%/z2.0-4.0/ez0.2/24bps/30s/WL/LL/$10k"},
    "JJ": {"db": "exp_jj.db", "label": "$1k/d $50k",
            "desc": "60pos/15tok/5x/10%/z1.5-4.0/ez0.1/24bps/30s/WL/100hr/LL/$50k"},
    "KK": {"db": "exp_kk.db", "label": "$1k/d opt",
            "desc": "60pos/15tok/5x/10%/z1.5-4.0/ez0.1/3bps/30s/WL/100hr/LL/$50k"},
    "KK2": {"db": "exp_kk2.db", "label": "KK $1k SwQOS",
             "desc": "60pos/15tok/5x/10%/z1.5-4.0/ez0.1/3bps/30s/WL/100hr/SwQOS/$1k"},
    ...
    "MM": {"db": "exp_mm.db", "label": "LST $50k",
            "desc": "60pos/15tok/5x/10%/z1.5-4.0/ez0.1/1bps/30s/LST/100hr/LL/$50k"},
    # Phase 5: Reinforcement learning
    "RL": {"db": "exp_rl.db", "label": "RL LST $10k",
            "desc": "40pos/10tok/5x/7%/z2.0-4.0/ez0.2/1bps/30s/LST/RL+KF/$10k"},
    "KF": {"db": "exp_kf.db", "label": "Kalman $10k",
            "desc": "40pos/10tok/5x/7%/z2.0-4.0/ez0.2/1bps/30s/LST/KF/$10k"},
}
